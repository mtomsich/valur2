...
<br>
		<div id="header3">
			<div class="textocatorce">
				...
				<p>_________________________________________________________________________________________________</p>
				<p>Origina  <?php echo $canp ?> unidades funcionales y  <?php echo $canc ?> unidades complementarias.</p>
			</div>
			<p class="textocatorce"><b>Notas del Plano de PH</b></p>
    ...
    <table class="cuadrado1">
      <tr>
        <td class="quince"> <center><?php echo $rati ?></center></td>
      </tr>
    </table>
