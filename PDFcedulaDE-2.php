	...
	<html lang="es">
	  ...
	  <body>
	    ...
	    <table class="tabla1">
	      ...
	      <tr>
	        <td class="letra1" colspan="7" height="20">
	          <div class="mar">DIRECCION PROVINCIAL CATASTRO TERRITORIAL </div>
	        </td>
					<td colspan="3"><div class="letra fondo decreto">&nbsp;&nbsp;Decreto 947/04</div></td>
	      ...
	      <tr>
	        ...
	        <td class="letra textol" rowspan="2" colspan="3"><b>NOMENCLATURA <br>CATASTRAL</b></td>
	        ...
	        <td class="bordes letra padleft">PARCELA</td>
					<td class="bordes letra padleft">SUBPARCELA</td>
	      </tr>
	      <tr>
	        <td colspan="2"></td>
	      ...
	      <tr>
	        <td class="bordes" colspan="12" height="505">
						<br><br>
						<div style="padding-left:5px;padding-top:-305px;font-size:12px;">
	      ...
	      <tr>
					<td class="letra" rowspan="3" colspan="3">
						<b>
							<div class="marg">
								Registrado
				...
				<td class="bordes padright letra" align="center" width="2%" height="110"><p class="textoinvertido" >Subparcela  <br><br> <b style="font-size:12"> <?php echo $Fsub ?> </b>	</p> </td>
				<td class="bordes letra" align="center" width="2%"> <p class="textoinvertido" > Parcela  <br><br> <b style="font-size:12"> <?php echo $Fpar ?> </b>	</p> </td>
				<td class="bordes letra" align="center" width="2%"> <p class="textoinvertido" > Manzana  <br><br> <b style="font-size:12"> <?php echo $Fman ?> </b>	</p> </td>
				<td class="bordes letra" align="center" width="2%"> <p class="textoinvertido" > Fraccion  <br><br> <b style="font-size:12"> <?php echo $Ffra ?> </b>	</p> </td>
				<td class="bordes letra" align="center" width="2%"> <p class="textoinvertido" > Quinta  <br><br> <b style="font-size:12"> <?php echo $Fqui ?> </b>	</p> </td>
				<td class="bordes letra" align="center" width="2%"> <p class="textoinvertido" > Chacra  <br><br> <b style="font-size:12"> <?php echo $Fcha ?> </b>	</p> </td>
				<td class="bordes letra" align="center" width="2%"> <p class="textoinvertido" > Seccion  <br><br> <b style="font-size:12"> <?php echo $Fsec ?> </b>	</p> </td>
				<td class="bordes letra" align="center" width="2%"> <p class="textoinvertido" > Circunsc.  <br><br> <b style="font-size:12"> <?php echo $Fcir ?> </b>	</p> </td>
				<td class="bordes letra" align="center" width="2%"> <p class="textoinvertido" > Partido  <br><br> <b style="font-size:12"> <?php echo $FcodPartido ?> </b>	</p> </td>
				</tr>
	    </table>
