<?php
include("sesion.php");
$pagina='comunicadosPHRPmodificarPHP';
					...
					<div class="span12">
						<div class="widget">
									...
									<div>
										...
										<div class="col-lg-4 text-left">
											...
											<div class="col-lg-1 text-left">
												...
												<input class="form-control" type="text" name="rati" value="<?php echo $rati?>" maxlength="2">
											</div>
							...
							if (isset($_POST['actualizar'])){
								...
								$_POST['rest'], '','','','','','','','','','','','','','','','','','','','','','','','','','','','','',
								'','','','','','','','','','','','','','','','','','','','','',$_POST['canc'],$_POST['rati'],$_POST['firmaprof']
							);
						...
						echo "<a href='PDFcomunicaPHRP.php?idComunicado=$idComunicado' target='_blank'";
						echo "</script>";
