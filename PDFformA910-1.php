...
<?php
		...
		//calculo total valor actualizado
	  $total=(int)$entero+(int)$edifAct+(int)$mejAct+(int)$planAct+(int)$postura;
...
.alambrados {
	position:absolute; margin-top:420px; margin-left:748px; font-size:13px;
}
.silos {
	position:absolute; margin-top:544px; margin-left:748px; font-size:13px;
}
.molinos {
	position:absolute; margin-top:685px; margin-left:748px; font-size:13px;
}
.tanques {
	position:absolute; margin-top:817px; margin-left:755px; font-size:10.5px; text-align:center;
}
.plantaciones {
	position:absolute; margin-top:950px; margin-left:748px; font-size:13px;
}
.instalaciones {
	position:absolute; margin-top:842px; margin-left:10px; font-size:13px;
}
.mejoras {
	position:absolute; margin-top:972px; margin-left:10px; font-size:13px;
}
.resumen {
	position:absolute; margin-top:1232px; margin-left:6px; font-size:13px; text-align:center
}
.observaciones {
	position: absolute; margin-left: 396px; margin-top: 1110px; font-family: 'Arial',sans-serif;
}
#cuadrilla {
...
.col2 {
	position: absolute; margin-left: 740px; margin-top: 235px; font-family: 'Arial',sans-serif;
}
.izquierda {
	position: static;
}
	...
	<header>
  	<div class="contenedor">
		...
		<div class="header">
				<table>
					<tr>
						<td class="borde05px" style="font-size:54px;border-bottom-style:none;text-align:right" width="128"> <b> A- 910</b> </td>
		...
		<div class="partido">
			...
			<div class="alambrados">
				<b style="transform: rotate(-90deg)"> ALAMBRADOS </b>
			</div>
			<div class="silos">
				<b style="transform: rotate(-90deg)"> SILOS </b>
			</div>
			<div class="molinos">
				<b style="transform: rotate(-90deg)"> MOLINOS </b>
			</div>
			<div class="tanques">
				<b style="transform: rotate(-90deg)"> TANQUES<br>AUSTRALIANOS </b>
			</div>
			<div class="plantaciones">
				<b style="transform: rotate(-90deg)"> PLANTACIONES </b>
			</div>
			<table>
				<tr>
			...
			<table class="tablaborde1px" style="border-top-style:none" width="747">
				...
				<tr>
					...
					<td class="borde05px" style="border-left-width:1.3px"> Aptitud Media </td>
					<td class="borde05px"> Valor Optimo </td>
					<td class="borde05px"> Superficie en Ha. </td>
				...
				<tr>
					...
					<td class="borde05px" style="border-right-width:1.3px"> <?php checkbox($FinfraG) ?> </td>
					<td class="borde05px" style="border-left-width:1.3px"> <?php echo $aptitud ?> </td>
					<td class="borde05px"> <?php echo $tierraAju ?> </td>
					<td class="borde05px"> <?php echo $superficie ?> </td>
					<td class="borde05px"> <?php echo $entero ?> </td>
				</tr>
			</table>
			<table class="tablaborde1px" style="border-left-width:2px; border-right-width:2.5px;border-bottom-width:0.3" width="550">
				<tr>
					<td class="borde05px" colspan="3"> <b> FORMULARIO </b> </td>
					<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario1)) {echo $formulario1;} ?> </b> </td>
					<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario2)) {echo $formulario2;} ?> </b> </td>
					<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario3)) {echo $formulario3;} ?> </b> </td>
					<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario4)) {echo $formulario4;} ?> </b> </td>
					<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario5)) {echo $formulario5;} ?> </b> </td>
				</tr>
				<tr>
					<td class="borde05px" rowspan="10" width="18"> </td>
					<td class="borde05px" rowspan="5" style="border-right-style:none" width="94"> TILDES </td>
				...
				<tr>
					...
					<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado1)) {echo $valorEstado1;} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado1)) {echo $Estado1;} ?> </td>
					<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado2)) {echo $valorEstado2;} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado2)) {echo $Estado2;} ?> </td>
					<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado3)) {echo $valorEstado3;} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado3)) {echo $Estado3;} ?> </td>
					<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado4)) {echo $valorEstado4;} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado4)) {echo $Estado4;} ?> </td>
					<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado5)) {echo $valorEstado5;} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado5)) {echo $Estado5;} ?> </td>
				</tr>
				<tr>
			...
			<table class="tablaborde1px" width="550" style="border-top-width:0.5px;border-left-width:2px; border-right-width:2.5px; border-bottom-width:0.5px">
				<tr>
					<td class="borde05px" rowspan="17" width="19"> </td>
					<td class="borde05px" colspan="2" style="text-align:left"> Heladera c/equip. central </td>
					<td class="borde05px" colspan="4"> <?php if(isset($heladera1)) {if ($heladera1 == 0) {echo "";} else {echo $heladera1;}} ?> </td>
					<td class="borde05px" colspan="4"> <?php if(isset($heladera2)) {if ($heladera2 == 0) {echo "";} else {echo $heladera2;}} ?> </td>
					<td class="borde05px" colspan="4"> <?php if(isset($heladera3)) {if ($heladera3 == 0) {echo "";} else {echo $heladera3;}} ?> </td>
					<td class="borde05px" colspan="4"> <?php if(isset($heladera4)) {if ($heladera4 == 0) {echo "";} else {echo $heladera4;}} ?> </td>
					<td class="borde05px" colspan="4"> <?php if(isset($heladera5)) {if ($heladera5 == 0) {echo "";} else {echo $heladera5;}} ?> </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="borde05px" width="8" style="border-right-color:#A4A4A4"> P </td>
			...
			<table class="tablaborde1px" width="550" style="border-top-width:0.5px;border-left-width:2px;border-right-width:2px">
				<tr>
					<td class="borde05px" colspan="3" style="border-bottom-width:1.5px" width="79"> VALOR FISCAL EDIFICIO </td>
				...
				<tr>
					<td class="borde05px" rowspan="5" width="19"> </td>
					<td class="borde05px" rowspan="3" colspan="2" style="text-align:left" width="127"> Tanques (Cant/Cap m<sup>3</sup>) </td>
					<td class="borde05px" style="border-right-color:#A4A4A4" height="12" width="20"> <?php if(isset($tancant11)) {if ($tancant11 == 0) {echo "";} else {echo $tancant11;}} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap11)) {if ($tancap11 == 0) {echo "";} else {echo $tancap11;}} ?> </td>
					<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant12)) {if ($tancant12 == 0) {echo "";} else {echo $tancant12;}} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap12)) {if ($tancap12 == 0) {echo "";} else {echo $tancap12;}} ?> </td>
					<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant13)) {if ($tancant13 == 0) {echo "";} else {echo $tancant13;}} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap13)) {if ($tancap13 == 0) {echo "";} else {echo $tancap13;}} ?> </td>
					<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant14)) {if ($tancant14 == 0) {echo "";} else {echo $tancant14;}} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap14)) {if ($tancap14 == 0) {echo "";} else {echo $tancap14;}} ?> </td>
					<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant15)) {if ($tancant15 == 0) {echo "";} else {echo $tancant15;}} ?> </td>
					<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap15)) {if ($tancap15 == 0) {echo "";} else {echo $tancap15;}} ?> </td>
				</tr>
				<tr>
			...
			<?php if($a > 5){ ?>
				<table class="tablaborde1px" style="border-width:2px;border-top-width:1px" width="290">
					<tr>
						<td class="borde05px" rowspan="7" width="23"> </td>
						<td class="borde05px"> </td>
						<td class="borde05px" style="font-size:11px"> VALOR BÁSICO (1955) </td>
						<td class="borde05px" style="font-size:11px" width="100"> VALOR ACTUALIZADO </td>
					</tr>
					<tr>
					...
					<tr>
						<td class="borde05px" style="text-align:left"> Plantación </td>
						<td class="borde05px"> </td>
						<td class="borde05px"> </td>
					</tr>
					<tr>
			...
			<table class="tablaborde1px" style="border-width:2px;border-top-width:1px" width="290">
				...
				<tr>
					<td class="borde05px" style="text-align:left"> Tierra </td>
					<td class="borde05px"> <?php echo number_format((float)$tierraBas,0,',','.') ?> </td>
					<td class="borde05px"> <?php echo number_format((float)$entero,0,',','.') ?> </td>
				</tr>
				<tr>
					<td class="borde05px" style="text-align:left"> Edificio </td>
					<td class="borde05px"> </td>
				...
				<tr>
					<td class="borde05px" style="text-align:left"> Plantación </td>
					<td class="borde05px"> </td>
					<td class="borde05px"> <?php echo number_format((float)$planAct,0,',','.') ?> </td>
				</tr>
				<tr>
					<td class="borde05px" style="text-align:left" width="50"> (*) Postura </td>
					<td class="borde05px"> </td>
		...
		<div class="col2">
			<table class="tablaborde1px" width="192" style="border-width:2px;border-bottom-width:0.8px">
				<tr>
					<td class="borde05px" colspan="5"> <b> FORMULARIO 912 </b> </td>
				</tr>
				<tr>
					<td class="borde05px" width="15" rowspan="10"> </td>
					<td class="borde05px" width="15"> T </td>
					<td class="borde05px" width="15"> E </td>
					<td class="borde05px"> NO MED. </td>
					<td class="borde05px"> MED. </td>
				</tr>
				<tr>
					<td class="borde05px" rowspan="3"> A </td>
					<td class="borde05px"> B </td>
					<td class="borde05px"> <?php if(isset($ala1)) {if ($ala1 == 0) {echo "";} else {echo $ala1;}} ?> </td>
					<td class="borde05px"> <?php if(isset($ala2)) {if ($ala4 == 0) {echo "";} else {echo $ala4;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> R </td>
					<td class="borde05px"> <?php if(isset($ala3)) {if ($ala2 == 0) {echo "";} else {echo $ala2;}} ?> </td>
					<td class="borde05px"> <?php if(isset($ala4)) {if ($ala5 == 0) {echo "";} else {echo $ala5;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> M </td>
					<td class="borde05px"> <?php if(isset($ala5)) {if ($ala3 == 0) {echo "";} else {echo $ala3;}} ?> </td>
					<td class="borde05px"> <?php if(isset($ala6)) {if ($ala6 == 0) {echo "";} else {echo $ala6;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px" rowspan="3"> B </td>
					<td class="borde05px"> B </td>
					<td class="borde05px"> <?php if(isset($ala7)) {if ($ala7 == 0) {echo "";} else {echo $ala7;}} ?> </td>
					<td class="borde05px"> <?php if(isset($ala8)) {if ($ala10 == 0) {echo "";} else {echo $ala10;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> R </td>
					<td class="borde05px"> <?php if(isset($ala9)) {if ($ala8 == 0) {echo "";} else {echo $ala8;}} ?> </td>
					<td class="borde05px"> <?php if(isset($ala10)) {if ($ala11 == 0) {echo "";} else {echo $ala11;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> M </td>
					<td class="borde05px"> <?php if(isset($ala11)) {if ($ala9 == 0) {echo "";} else {echo $ala9;}} ?> </td>
					<td class="borde05px"> <?php if(isset($ala12)) {if ($ala12 == 0) {echo "";} else {echo $ala12;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px" rowspan="3"> C </td>
					<td class="borde05px"> B </td>
					<td class="borde05px"> <?php if(isset($ala13)) {if ($ala13 == 0) {echo "";} else {echo $ala13;}} ?> </td>
					<td class="borde05px"> <?php if(isset($ala14)) {if ($ala16 == 0) {echo "";} else {echo $ala16;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> R </td>
					<td class="borde05px"> <?php if(isset($ala15)) {if ($ala14 == 0) {echo "";} else {echo $ala14;}} ?> </td>
					<td class="borde05px"> <?php if(isset($ala16)) {if ($ala17 == 0) {echo "";} else {echo $ala17;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> M </td>
					<td class="borde05px"> <?php if(isset($ala17)) {if ($ala15 == 0) {echo "";} else {echo $ala15;}} ?> </td>
					<td class="borde05px"> <?php if(isset($ala18)) {if ($ala18 == 0) {echo "";} else {echo $ala18;}} ?> </td>
				</tr>
			</table>
			<table class="tablaborde1px" width="192" style="margin-top:-1px;border-width:2px;border-top-width:0.8px;border-bottom-width:0.8px">
				<tr>
					<td class="borde05px" rowspan="4" width="15"> </td>
					<td class="borde05px" width="15"> T </td>
					<td class="borde05px" width="15"> E </td>
					<td class="borde05px" width="45"> DATA </td>
					<td class="borde05px" style="font-size:11px"> Capacidad Total de M3 </td>
				</tr>
				<tr>
					<td class="borde05px"> A </td>
					<td class="borde05px"> B </td>
					<td class="borde05px" width="70"> <?php if(isset($siloData1)) {if ($siloData1 == 0) {echo "";} else {echo $siloData1;}} ?> </td>
					<td class="borde05px"> <?php if(isset($siloCap1)) {if ($siloCap1 == 0) {echo "";} else {echo ((int)$siloCant1*(int)$siloCap1);}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> B </td>
					<td class="borde05px"> R </td>
					<td class="borde05px"> <?php if(isset($siloData2)) {if ($siloData2 == 0) {echo "";} else {echo $siloData2;}} ?> </td>
					<td class="borde05px"> <?php if(isset($siloCap2)) {if ($siloCap2 == 0) {echo "";} else {echo ((int)$siloCant2*(int)$siloCap2);}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> C </td>
					<td class="borde05px"> M </td>
					<td class="borde05px"> <?php if(isset($siloData3)) {if ($siloData3 == 0) {echo "";} else {echo $siloData3;}} ?> </td>
					<td class="borde05px"> <?php if(isset($siloCap3)) {if ($siloCap3 == 0) {echo "";} else {echo ((int)$siloCant3*(int)$siloCap3);}} ?> </td>
				</tr>
			</table>
			<table class="tablaborde1px" width="192" style="margin-top:-1px;border-width:2px;border-top-width:0.8px;border-bottom-width:0.8px">
				<tr>
					<td class="borde05px" rowspan="7" width="15"> </td>
					<td class="borde05px" width="15"> T </td>
					<td class="borde05px" width="15"> E </td>
					<td class="borde05px"> CANTIDAD </td>
				</tr>
				<tr>
					<td class="borde05px" rowspan="3"> A </td>
					<td class="borde05px"> B </td>
					<td class="borde05px"> <?php if(isset($moliCant1)) {if ($moliCant1 == 0) {echo "";} else {echo $moliCant1;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> R </td>
					<td class="borde05px"> <?php if(isset($moliCant2)) {if ($moliCant2 == 0) {echo "";} else {echo $moliCant2;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> M </td>
					<td class="borde05px"> <?php if(isset($moliCant3)) {if ($moliCant3 == 0) {echo "";} else {echo $moliCant3;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px" rowspan="3"> B </td>
					<td class="borde05px"> B </td>
					<td class="borde05px"> <?php if(isset($moliCant4)) {if ($moliCant4 == 0) {echo "";} else {echo $moliCant4;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> R </td>
					<td class="borde05px"> <?php if(isset($moliCant5)) {if ($moliCant5 == 0) {echo "";} else {echo $moliCant5;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> M </td>
					<td class="borde05px"> <?php if(isset($moliCant6)) {if ($moliCant6 == 0) {echo "";} else {echo $moliCant6;}} ?> </td>
				</tr>
			</table>
			<table class="tablaborde1px" width="192" style="margin-top:-1px;border-width:2px;border-bottom-width:0.8px;border-top-width:0.8px">
				<tr>
					<td class="borde05px" rowspan="4" width="35"> </td>
					<td class="borde05px" width="15"> E </td>
					<td class="borde05px"> CANTIDAD </td>
				</tr>
				<tr>
					<td class="borde05px"> B </td>
					<td class="borde05px"> <?php if(isset($tanCant1)) {if ($tanCant1 == 0) {echo "";} else {echo $tanCant1;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> R </td>
					<td class="borde05px"> <?php if(isset($tanCant2)) {if ($tanCant2 == 0) {echo "";} else {echo $tanCant2;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px"> M </td>
					<td class="borde05px"> <?php if(isset($tanCant3)) {if ($tanCant3 == 0) {echo "";} else {echo $tanCant3;}} ?> </td>
				</tr>
			</table>
			<table class="tablaborde1px" width="192" style="margin-top:-1px;border-width:2px;border-top-width:0.8px">
				<tr>
					<td class="borde05px" rowspan="7" width="15"> </td>
					<td class="borde05px" width="35"> VAR. </td>
					<td class="borde05px"> SUPER. </td>
					<td class="borde05px"> E </td>
					<td class="borde05px"> P </td>
				</tr>
				<tr>
					<td class="borde05px" height="12"> <?php if(isset($plantDet1)) {echo $plantDet1;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantSup1)) {echo $plantSup1;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantEst1)) {if ($plantEst1 == 0) {echo "";} else {echo $plantEst1;}} ?> </td>
					<td class="borde05px"> <?php if(isset($plantP1)) {if ($plantP1 == 0) {echo "";} else {echo $plantP1;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px" height="12"> <?php if(isset($plantDet2)) {echo $plantDet2;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantSup2)) {echo $plantSup2;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantEst2)) {if ($plantEst2 == 0) {echo "";} else {echo $plantEst2;}} ?> </td>
					<td class="borde05px"> <?php if(isset($plantP2)) {if ($plantP2 == 0) {echo "";} else {echo $plantP2;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px" height="12"> <?php if(isset($plantDet3)) {echo $plantDet3;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantSup3)) {echo $plantSup3;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantEst3)) {if ($plantEst3 == 0) {echo "";} else {echo $plantEst3;}} ?> </td>
					<td class="borde05px"> <?php if(isset($plantP3)) {if ($plantP3 == 0) {echo "";} else {echo $plantP3;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px" height="12"> <?php if(isset($plantDet4)) {echo $plantDet4;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantSup4)) {echo $plantSup4;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantEst4)) {if ($plantEst4 == 0) {echo "";} else {echo $plantEst4;}} ?> </td>
					<td class="borde05px"> <?php if(isset($plantP4)) {if ($plantP4 == 0) {echo "";} else {echo $plantP4;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px" height="12"> <?php if(isset($plantDet5)){echo $plantDet5;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantSup5)) {echo $plantSup5;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantEst5)) {if ($plantEst5 == 0) {echo "";} else {echo $plantEst5;}} ?> </td>
					<td class="borde05px"> <?php if(isset($plantP5)) {if ($plantP5 == 0) {echo "";} else {echo $plantP5;}} ?> </td>
				</tr>
				<tr>
					<td class="borde05px" height="12"> <?php if(isset($plantDet6)) {echo $plantDet6;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantSup6)) {echo $plantSup6;} ?> </td>
					<td class="borde05px"> <?php if(isset($plantEst6)) {if ($plantEst6 == 0) {echo "";} else {echo $plantEst6;}} ?> </td>
					<td class="borde05px"> <?php if(isset($plantP6)) {if ($plantP6 == 0) {echo "";} else {echo $plantP6;}} ?> </td>
				</tr>
			</table>
			<table class="tablaborde1px" width="192" style="margin-top:40px;border-width:2px">
				<tr>
					<td style="text-align:left;padding:10px"> <b> Formulario 915 </b> </td>
				</tr>
				<tr>
					<td style="text-align:left;padding:10px"> <b> $ (pesos): <?php if (isset($totalForm915)){echo number_format((float)$totalForm915,0,',','.');} ?> </b> </td>
				</tr>
			</table>
		</div>
		<div class="observaciones">
			<table class="tablaborde1px" width="450" style="border-width:2px">
				<tr>
				...
				<tr>
					<td class="borde05px" colspan="5" valign="top" style="border-top-style:none;text-align:left;" height="92"> <?php echo $observacion ?> </td>
				</tr>
			</table>
		</div>
	...
	<div class="partido">
		...
		<table class="tablaborde1px" style="border-top-style:none" width="747">
			...
			<tr>
				...
				<td class="borde05px" style="border-right-width:1.3px"> <?php $infraG = checkbox($infraG) ?> </td>
				<td class="borde05px" style="border-left-width:1.3px"> <?php echo $aptitud ?> </td>
				<td class="borde05px"> <?php echo $tierraAju ?> </td>
				<td class="borde05px"> <?php echo $superficie ?> </td>
				<td class="borde05px"> <?php echo $entero ?> </td>
		...
		<table class="tablaborde1px" style="border-left-width:2px; border-right-width:2.5px;border-bottom-width:0.3" width="550">
			<tr>
				<td class="borde05px" colspan="3"> <b> FORMULARIO </b> </td>
				<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario6)) {echo $formulario6;} ?> </b> </td>
				<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario7)) {echo $formulario7;} ?> </b> </td>
				<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario8)) {echo $formulario8;} ?> </b> </td>
				<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario9)) {echo $formulario9;} ?> </b> </td>
				<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario10)) {echo $formulario10;} ?> </b> </td>
			</tr>
			<tr>
				<td class="borde05px" rowspan="10" width="18"> </td>
				<td class="borde05px" rowspan="5" style="border-right-style:none" width="94"> TILDES </td>
			...
			<tr>
				<td class="borde05px" colspan="2" style="text-align:left"> Suma de Puntos /Estado </td>
				<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado6)) {echo $valorEstado6;} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado6)) {echo $Estado6;} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado7)) {echo $valorEstado7;} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado7)) {echo $Estado7;} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado8)) {echo $valorEstado8;} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado8)) {echo $Estado8;} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado9)) {echo $valorEstado9;} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado9)) {echo $Estado9;} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado10)) {echo $valorEstado10;} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado10)) {echo $Estado10;} ?> </td>
			</tr>
			<tr>
				<td class="borde05px" colspan="2" style="text-align:left"> Data </td>
		...
		<table class="tablaborde1px" width="550" style="border-top-width:0.5px;border-left-width:2px; border-right-width:2.5px; border-bottom-width:0.5px">
			<tr>
				<td class="borde05px" rowspan="17" width="19"> </td>
				<td class="borde05px" colspan="2" style="text-align:left"> Heladera c/equip. central </td>
				<td class="borde05px" colspan="4"> <?php if(isset($heladera6)) {if ($heladera6 == 0) {echo "";} else {echo $heladera6;}} ?> </td>
				<td class="borde05px" colspan="4"> <?php if(isset($heladera7)) {if ($heladera7 == 0) {echo "";} else {echo $heladera7;}} ?> </td>
				<td class="borde05px" colspan="4"> <?php if(isset($heladera8)) {if ($heladera8 == 0) {echo "";} else {echo $heladera8;}} ?> </td>
				<td class="borde05px" colspan="4"> <?php if(isset($heladera9)) {if ($heladera9 == 0) {echo "";} else {echo $heladera9;}} ?> </td>
				<td class="borde05px" colspan="4"> <?php if(isset($heladera10)) {if ($heladera10 == 0) {echo "";} else {echo $heladera10;}} ?> </td>
			</tr>
			<tr>
				<td class="borde05px" colspan="2" style="text-align:left"> Aire Acondicionado </td>
			...
			<tr>
				<td class="borde05px" width="64"> -/= de 3 tons </td>
				<td class="borde05px" style="border-right-color:#A4A4A4"> P </td>
				<td class="borde05px" style="border-style:none;border-right-style:none"> <?php if(isset($monta26)) {if ($monta26 == 0) {echo "";} else {echo $monta26;}} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4"> C </td>
				...
				<td class="borde05px" style="border-right-color:#A4A4A4"> P </td>
				<td class="borde05px" style="border-left-style:none;border-right-style:none"> <?php if(isset($monta28)) {if ($monta28 == 0) {echo "";} else {echo $monta28;}} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4"> C </td>
		...
		<table class="tablaborde1px" width="550" style="border-top-width:0.5px;border-left-width:2px;border-right-width:2px">
			...
			<tr>
				<td class="borde05px" rowspan="5" width="19"> </td>
				<td class="borde05px" rowspan="3" colspan="2" style="text-align:left" width="127"> Tanques (Cant/Cap m<sup>3</sup>) </td>
				<td class="borde05px" style="border-right-color:#A4A4A4" height="12" width="20"> <?php if(isset($tancant16)) {if ($tancant16 == 0) {echo "";} else {echo $tancant16;}} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap16)) {if ($tancap16 == 0) {echo "";} else {echo $tancap16;}} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant17)) {if ($tancant17 == 0) {echo "";} else {echo $tancant17;}} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap17)) {if ($tancap17 == 0) {echo "";} else {echo $tancap17;}} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant18)) {if ($tancant18 == 0) {echo "";} else {echo $tancant18;}} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap18)) {if ($tancap18 == 0) {echo "";} else {echo $tancap18;}} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant19)) {if ($tancant19 == 0) {echo "";} else {echo $tancant19;}} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap19)) {if ($tancap19 == 0) {echo "";} else {echo $tancap19;}} ?> </td>
				<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant110)) {if ($tancant110 == 0) {echo "";} else {echo $tancant110;}} ?> </td>
				<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap110)) {if ($tancap110 == 0) {echo "";} else {echo $tancap110;}} ?> </td>
			</tr>
			<tr>
				<td class="borde05px" style="border-right-color:#A4A4A4" height="12"> <?php if(isset($tancant26)) {if ($tancant26 == 0) {echo "";} else {echo $tancant26;}} ?> </td>
				...
				<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if(isset($tancant28)) {if ($tancant28 == 0) {echo "";} else {echo $tancant28;}} ?> </td>
			...
			<tr>
				<td class="borde05px" style="border-right-color:#A4A4A4" height="12"> <?php if(isset($tancant36)) {if ($tancant36 == 0) {echo "";} else {echo $tancant36;}} ?> </td>
				...
				<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if(isset($tancant38)) {if ($tancant38 == 0) {echo "";} else {echo $tancant38;}} ?> </td>
		...
		<table class="tablaborde1px" style="border-width:2px;border-top-width:1px" width="290">
			...
			<tr>
				<td class="borde05px" style="text-align:left"> Plantación </td>
				<td class="borde05px"> </td>
				<td class="borde05px"> <?php echo number_format($planAct,0,',','.') ?> </td>
			</tr>
			<tr>
				<td class="borde05px" style="text-align:left" width="50"> (*) Postura </td>
				<td class="borde05px"> </td>
	...
	<div class="col2">
		...
		<table class="tablaborde1px" width="192" style="margin-top:-1px;border-width:2px;border-top-width:0.8px;border-bottom-width:0.8px">
			...
			<tr>
				...
				<td class="borde05px"> B </td>
				<td class="borde05px" width="70"> <?php if(isset($siloData1)) {if ($siloData1 == 0) {echo "";} else {echo $siloData1;}} ?> </td>
				<td class="borde05px"> <?php if(isset($siloCap1)) {if ($siloCap1 == 0) {echo "";} else {echo $siloCap1;}} ?> </td>
			</tr>
			<tr>
				<td class="borde05px"> B </td>
				<td class="borde05px"> R </td>
				<td class="borde05px"> <?php if(isset($siloData2)) {if ($siloData2 == 0) {echo "";} else {echo $siloData2;}} ?> </td>
				<td class="borde05px"> <?php if(isset($siloCap2)) {if ($siloCap2 == 0) {echo "";} else {echo $siloCap2;}} ?> </td>
			</tr>
			<tr>
				<td class="borde05px"> C </td>
				<td class="borde05px"> M </td>
				<td class="borde05px"> <?php if(isset($siloData3)) {if ($siloData3 == 0) {echo "";} else {echo $siloData3;}} ?> </td>
				<td class="borde05px"> <?php if(isset($siloCap3)) {if ($siloCap3 == 0) {echo "";} else {echo $siloCap3;}} ?> </td>
			</tr>
		</table>
		<table class="tablaborde1px" width="192" style="margin-top:-1px;border-width:2px;border-top-width:0.8px;border-bottom-width:0.8px">
			<tr>
...
<div class="partido">
	...
	<table class="tablaborde1px" style="border-left-width:2px; border-right-width:2.5px;border-bottom-width:0.3" width="550">
		<tr>
			<td class="borde05px" colspan="3"> <b> FORMULARIO </b> </td>
			<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario11)) {echo $formulario11;} ?> </b> </td>
			<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario12)) {echo $formulario12;} ?> </b> </td>
			<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario13)) {echo $formulario13;} ?> </b> </td>
			<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario14)) {echo $formulario14;} ?> </b> </td>
			<td class="borde05px" colspan="2" width="70"> <b> <?php if (isset($formulario15)) {echo $formulario15;} ?> </b> </td>
		</tr>
		<tr>
			<td class="borde05px" rowspan="10" width="18"> </td>
			<td class="borde05px" rowspan="5" style="border-right-style:none" width="94"> TILDES </td>
			...
			<td class="borde05px" colspan="2"> <?php if (isset($totalA15)) {if ($totalA15 == 0) {echo "";} else {echo $totalA15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px"> B </td>
			...
			<td class="borde05px" colspan="2"> <?php if (isset($totalB15)) {if ($totalB15 == 0) {echo "";} else {echo $totalB15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px"> C </td>
			...
			<td class="borde05px" colspan="2"> <?php if (isset($totalC15)) {if ($totalC15 == 0) {echo "";} else {echo $totalC15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px"> D </td>
			...
			<td class="borde05px" colspan="2"> <?php if (isset($totalD15)) {if ($totalD15 == 0) {echo "";} else {echo $totalD15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px"> E </td>
			...
			<td class="borde05px" colspan="2"> <?php if (isset($totalE15)) {if ($totalE15 == 0) {echo "";} else {echo $totalE15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Suma de Puntos /Estado </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado11)) {echo $valorEstado11;} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado11)) {echo $Estado11;} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado12)) {echo $valorEstado12;} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado12)) {echo $Estado12;} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado13)) {echo $valorEstado13;} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado13)) {echo $Estado13;} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado14)) {echo $valorEstado14;} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado14)) {echo $Estado14;} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if (isset($valorEstado15)) {echo $valorEstado15;} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="15"> <?php if (isset($Estado15)) {echo $Estado15;} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Data </td>
			...
			<td class="borde05px" colspan="2"> <?php if(isset($data15)) {if ($data15 == 0) {echo "";} else {echo $data15;}} ?></td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Data de reciclado</td>
			...
			<td class="borde05px" colspan="2"> <?php if(isset($datare15)) {if ($datare15 == 0) {echo "";} else {echo $datare15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Superficie cubierta </td>
			...
			<td class="borde05px" colspan="2"> <?php if(isset($cubierta15)) {if ($cubierta15 == 0) {echo "";} else {echo $cubierta15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Superficie semicubierta </td>
			...
			<td class="borde05px" colspan="2"> <?php if(isset($semicub15)) {if ($semicub15 == 0) {echo "";} else {echo $semicub15;}} ?> </td>
		</tr>
	</table>
	<table class="tablaborde1px" width="550" style="border-top-width:0.5px;border-left-width:2px; border-right-width:2.5px; border-bottom-width:0.5px">
		<tr>
			<td class="borde05px" rowspan="17" width="19"> </td>
			<td class="borde05px" colspan="2" style="text-align:left"> Heladera c/equip. central </td>
			<td class="borde05px" colspan="4"> <?php if(isset($heladera11)) {if ($heladera11 == 0) {echo "";} else {echo $heladera11;}} ?> </td>
			<td class="borde05px" colspan="4"> <?php if(isset($heladera12)) {if ($heladera12 == 0) {echo "";} else {echo $heladera12;}} ?> </td>
			<td class="borde05px" colspan="4"> <?php if(isset($heladera13)) {if ($heladera13 == 0) {echo "";} else {echo $heladera13;}} ?> </td>
			<td class="borde05px" colspan="4"> <?php if(isset($heladera14)) {if ($heladera14 == 0) {echo "";} else {echo $heladera14;}} ?> </td>
			<td class="borde05px" colspan="4"> <?php if(isset($heladera15)) {if ($heladera15 == 0) {echo "";} else {echo $heladera15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Aire Acondicionado </td>
			...
			<td class="borde05px" colspan="4"> <?php if(isset($aire15)) {if ($aire15 == 0) {echo "";} else {echo $aire15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Calefacción central </td>
			...
			<td class="borde05px" colspan="4"> <?php if(isset($calefaccion15)) {if ($calefaccion15 == 0) {echo "";} else {echo $calefaccion15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Losa radiante </td>
			...
			<td class="borde05px" colspan="4"> <?php if(isset($losa15)) {if ($losa15 == 0) {echo "";} else {echo $losa15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px"colspan="2"  style="text-align:left"> Horno incinerador </td>
			...
			<td class="borde05px" colspan="4"> <?php if(isset($horno15)) {if ($horno15 == 0) {echo "";} else {echo $horno15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Agua caliente central </td>
			...
			<td class="borde05px" colspan="4"> <?php if(isset($agua15)) {if ($agua15 == 0) {echo "";} else {echo $agua15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Baño principal </td>
			...
			<td class="borde05px" colspan="4"> <?php if(isset($bano115)) {if ($bano115 == 0) {echo "";} else {echo $bano115;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Baño secundario </td>
			...
			<td class="borde05px" colspan="4"> <?php if(isset($bano215)) {if ($bano215 == 0) {echo "";} else {echo $bano215;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Cámara frigorífica </td>
			...
			<td class="borde05px" colspan="4"> <?php if(isset($camara15)) {if ($camara15 == 0) {echo "";} else {echo $camara15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="2" style="text-align:left"> Instalac. contra incendios </td>
			...
			<td class="borde05px" colspan="4"> <?php if(isset($incendio15)) {if ($incendio15 == 0) {echo "";} else {echo $incendio15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" rowspan="2" style="border-right-style:none"> Ascensores </td>
			<td class="borde05px"> + de 4 pers. </td>
			...
			<td class="borde05px" width="8" style="border-right-color:#A4A4A4"> P </td>
			<td class="borde05px" width="21" style="border-left-style:none;border-right-style:none"> <?php if(isset($ascensores115)) {if ($ascensores115 == 0) {echo "";} else {echo $ascensores115;}} ?> </td>
			<td class="borde05px" width="8" style="border-right-color:#A4A4A4"> C </td>
			<td class="borde05px" width="21" style="border-left-style:none"> <?php if(isset($ascensoresCant115)) {if ($ascensoresCant115 == 0) {echo "";} else {echo $ascensoresCant115;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px"> -/= de 4 pers. </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> P </td>
			...
			<td class="borde05px" style="border-right-color:#A4A4A4"> P </td>
			<td class="borde05px" style="border-left-style:none;border-right-style:none"> <?php if(isset($ascensores215)) {if ($ascensores215 == 0) {echo "";} else {echo $ascensores215;}} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> C </td>
			<td class="borde05px" style="border-left-style:none"> <?php if(isset($ascensoresCant215)) {if ($ascensoresCant215 == 0) {echo "";} else {echo $ascensoresCant215;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" rowspan="2" width="60" style="border-right-style:none"> Montacargas </td>
			<td class="borde05px"> + de 3 tons </td>
			...
			<td class="borde05px" style="border-right-color:#A4A4A4"> P </td>
			<td class="borde05px" style="border-left-style:none;border-right-style:none"> <?php if(isset($monta115)) {if ($monta115 == 0) {echo "";} else {echo $monta115;}} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> C </td>
			<td class="borde05px" style="border-left-style:none"> <?php if(isset($monta1115)) {if ($monta1115 == 0) {echo "";} else {echo $monta1115;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" width="64"> -/= de 3 tons </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> P </td>
			<td class="borde05px" style="border-style:none;border-right-style:none"> <?php if(isset($monta211)) {if ($monta211 == 0) {echo "";} else {echo $monta211;}} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> C </td>
			...
			<td class="borde05px" style="border-right-color:#A4A4A4"> P </td>
			<td class="borde05px" style="border-left-style:none;border-right-style:none"> <?php if(isset($monta215)) {if ($monta215 == 0) {echo "";} else {echo $monta215;}} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4"> C </td>
			<td class="borde05px" style="border-left-style:none"> <?php if(isset($monta2215)) {if ($monta2215 == 0) {echo "";} else {echo $monta2215;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" rowspan="3" style="border-right-style:none"> Pileta de <br> natación </td>
			<td class="borde05px"> A </td>
			...
			<td class="borde05px" colspan="4"> <?php if (isset($pileta15) || isset($piletaCant15)) {$piletaA15 = pileA($pileta15,$piletaCant15);} ?> </td>
		</tr>
		<tr>
			<td class="borde05px"> B </td>
			...
			<td class="borde05px" colspan="4"> <?php if (isset($pileta15) || isset($piletaCant15)) {$piletaB15 = pileB($pileta15,$piletaCant15);} ?> </td>
		</tr>
		<tr>
			<td class="borde05px"> C </td>
			...
			<td class="borde05px" colspan="4"> <?php if (isset($pileta15) || isset($piletaCant15)) {$piletaC15 = pileC($pileta15,$piletaCant15);} ?> </td>
		</tr>
	</table>
	<table class="tablaborde1px" width="550" style="border-top-width:0.5px;border-left-width:2px;border-right-width:2px">
		<tr>
			...
			<td class="borde05px" colspan="2" style="border-bottom-width:1.5px"> <?php if(isset($TotalRubro715)) {echo number_format((float)$TotalRubro715,0,',','.');} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" rowspan="5" width="19"> </td>
			<td class="borde05px" rowspan="3" colspan="2" style="text-align:left" width="127"> Tanques (Cant/Cap m<sup>3</sup>) </td>
			<td class="borde05px" style="border-right-color:#A4A4A4" height="12" width="20"> <?php if(isset($tancant111)) {if ($tancant111 == 0) {echo "";} else {echo $tancant111;}} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap111)) {if ($tancap111 == 0) {echo "";} else {echo $tancap111;}} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant112)) {if ($tancant112 == 0) {echo "";} else {echo $tancant112;}} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap112)) {if ($tancap112 == 0) {echo "";} else {echo $tancap112;}} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant113)) {if ($tancant113 == 0) {echo "";} else {echo $tancant113;}} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap113)) {if ($tancap113 == 0) {echo "";} else {echo $tancap113;}} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant114)) {if ($tancant114 == 0) {echo "";} else {echo $tancant114;}} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap114)) {if ($tancap114 == 0) {echo "";} else {echo $tancap114;}} ?> </td>
			<td class="borde05px" style="border-right-color:#A4A4A4" width="20"> <?php if(isset($tancant115)) {if ($tancant115 == 0) {echo "";} else {echo $tancant115;}} ?> </td>
			<td class="borde05px" style="border-left-style:none" width="48"> <?php if(isset($tancap115)) {if ($tancap115 == 0) {echo "";} else {echo $tancap115;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" style="border-right-color:#A4A4A4" height="12"> <?php if(isset($tancant211)) {if ($tancant211 == 0) {echo "";} else {echo $tancant211;}} ?> </td>
			...
			<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if(isset($tancant215)) {if ($tancant215 == 0) {echo "";} else {echo $tancant215;}} ?> </td>
			<td class="borde05px" style="border-left-style:none"> <?php if(isset($tancap215)) {if ($tancap215 == 0) {echo "";} else {echo $tancap215;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" style="border-right-color:#A4A4A4" height="12"> <?php if(isset($tancant311)) {if ($tancant311 == 0) {echo "";} else {echo $tancant311;}} ?> </td>
			...
			<td class="borde05px" style="border-right-color:#A4A4A4"> <?php if(isset($tancant315)) {if ($tancant315 == 0) {echo "";} else {echo $tancant315;}} ?> </td>
			<td class="borde05px" style="border-left-style:none"> <?php if(isset($tancap315)) {if ($tancap315 == 0) {echo "";} else {echo $tancap315;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" rowspan="2" style="text-align:left;border-right-style:none" width="63"> Pavimentos </td>
			<td class="borde05px" style="text-align:left"> Rígido </td>
			...
			<td class="borde05px" colspan="2"> <?php if(isset($pavrig15)) {if ($pavrig15 == 0) {echo "";} else {echo $pavrig15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" style="text-align:left"> Flexible </td>
			...
			<td class="borde05px" colspan="2"> <?php if(isset($pavflex15)) {if ($pavflex15 == 0) {echo "";} else {echo $pavflex15;}} ?> </td>
		</tr>
		<tr>
			<td class="borde05px" colspan="3" style="text-align:left"> VALOR FISCAL MEJORAS </td>
			<td class="borde05px" colspan="2"> </td>
...
<p class="numeroHoja"> 3-<?php echo $hoja ?> </p>
<?php } ?>
		<div style="page-break-after:always;"></div>
		<div class="hoja2">
			<img id="cuadrilla" src="img/Cuadrilla-A910.png">
			<table class="tablaborde1px" width="735" style="margin-top:20px">
				...
				<tr>
					<td class="borde05px" height="12" colspan="3" style="padding:6px;border-top-style:none;border-right-color:#A4A4A4;"> <?php echo $Fdcalle ?> </td>
					<td class="borde05px" style="border-left-style:none;border-top-style:none"> <?php echo $FdnroCalle ?> </td>
				</tr>
				<tr>
				...
				<tr>
					<td class="borde05px" height="12" style="padding:6px;border-top-style:none;border-right-color:#A4A4A4"> <?php echo $Fdpiso ?> </td>
					...
					<td class="borde05px" style="border-top-style:none;border-left-style:none"> <?php echo $Fdcp ?> </td>
				</tr>
				<tr>
					<td class="borde05px" style="text-align:left;border-bottom-color:#A4A4A4" colspan="4"> <b> Apellido y nombre del Destinatario </b> </td>
				</tr>
				<tr>
					<td class="borde05px" height="12" colspan="4" style="padding:6px;border-top-style:none"> <?php echo $FdnombreApellido ?> </td>
					<td> <b> VISADO </b> </td>
				</tr>
			</table>
		...
		<p class="numeroHojaAux"> <?php echo $hoja ?>-<?php echo $hoja ?> </p>
	</div>
	</body>
	</html>
	...
	$filename = $FcodPartido."-".$Fpartida."-Formulario A910.pdf";
